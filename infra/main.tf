...
# --- 2. Permissions: GCS -> Pub/Sub publisher ---
...
# --- 3. Artifact Registry for GCF Gen2 build artifacts ---
...
# --- 4. Document AI Processor (location is separate from region; keep us) ---
...
# --- 5. Archive & upload functions source ---
